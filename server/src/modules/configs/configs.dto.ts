...
export class Oauth2UnitDto {
  ...
  @IsString()
  @IsNotEmpty()
  @JSONSchemaPlainField('Client Secret')
  @SecretField
  clientSecret: string
...
export class MetaDto {
  // @IsEnum(Levels)
  // @IsNotEmpty()
  // @JSONSchemaHalfGirdPlainField('创建弹幕库的最低等级')
  // createMinLv: Levels
}
...
export class ScopeDto {
  ...
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('创建元数据的最低时间')
  metaCreate: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('元数据新增Hash的最低时间')
  metaHashNew: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('元数据投票Hash的最低时间')
  metaHashVote: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('发送弹幕的最低时间')
  danmakuSend: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('发送章节标记弹幕的最低时间')
  danmakuSendChapter: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('发送章节标记弹幕的最低自动通过时间')
  danmakuSendChapterPassCheck: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('发送至高级弹幕(池)的最低时间')
  danmakuSendAdv: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('发送至高级弹幕(池)的最低自动通过时间')
  danmakuSendAdvPassCheck: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('发送至必要内容/字幕/科普/章节弹幕(池)的最低时间')
  danmakuSendSub: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField(
    '发送至必要内容/字幕/科普/章节弹幕(池)的最低自动通过时间',
  )
  danmakuSendSubPassCheck: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('对弹幕进行点赞/举报的最低时间')
  danmakuEventIssue: number

  @IsInt()
  @Min(0)
  @IsNotEmpty()
  @JSONSchemaNumberField('对弹幕事件进行投票的最低时间')
  danmakuEventVote: number
}
...
export class DanmakuDto {
  ...
  // @IsEnum(Levels)
  // @IsNotEmpty()
  // @JSONSchemaHalfGirdPlainField('发送弹幕的最低等级')
  // minLv: Levels
  // @IsEnum(Levels)
  // @IsNotEmpty()
  // @JSONSchemaHalfGirdPlainField('发送章节标记弹幕的最低自动通过等级')
  // markChapterFullMinLv: Levels
  // @IsEnum(Levels)
  // @IsNotEmpty()
  // @JSONSchemaHalfGirdPlainField('发送非标准弹幕(池)的最低自动通过等级')
  // extFullMinLv: Levels
}
