...
export class DatabaseService {
  ...
  ReturnModelType<typeof MetaModel>
  // @ts-ignore
  // public getModelByRefType(
  ...
  // ): ReturnModelType<typeof RecentlyModel>
  // public getModelByRefType(type: 'meta'): ReturnModelType<typeof MetaModel>
  // public getModelByRefType(
  //   type: CollectionRefTypes.Meta,
  // ): ReturnModelType<typeof MetaModel>
  ...
  //     [CollectionRefTypes.Meta, this.metaModel],
  //   ] as any)
  ...
  //     this.metaModel.findById(id).lean(),
  //   ])
